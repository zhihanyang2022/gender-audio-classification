...
This a deep-learning project. It contains a ResNet-34 (convolutional neural network) trained on 24000 WAV audio files labelled by gender and validated on 6000 WAV audio files. The entire audio corpus consists of 30000 WAV audio files in total. It is generated by 60 unique speakers, each producing 50 instances of each digit (0-9). 
</div>
